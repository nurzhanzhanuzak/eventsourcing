...
* Fixed event hierarchy generated by BaseAggregate__init_subclass__ to preserve original hierarchy of user defined events.
...
* Improved type hinting in the code examples in the documentation.
