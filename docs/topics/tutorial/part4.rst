...
for generating events and for getting the counted number of events.
...
obtain the counted number of events. If a durable database is used in production, the event-sourced
...
the obtained counted number of events correctly report the total numbers of events that have been generated, and to
